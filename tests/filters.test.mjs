...
const L = [
  { id:"a", lng:77.60, lat:12.90, rent:30000, bhk:"2 BHK", listing_type:"entire_flat", furnishing:"Fully furnished", location:"HSR Layout Sector 2", audience:"any" },
  { id:"b", lng:77.64, lat:12.93, rent:16000, bhk:"1 BHK", listing_type:"flatmate", furnishing:"semi_furnished", location:"Koramangala 8th Block", audience:"female_only" },
  { id:"c", lng:77.70, lat:12.95, rent:45000, bhk:"3 BHK", listing_type:"pg_hostel", furnishing:null, location:"Indiranagar", audience:"any" },
];
...
test("hideFemaleOnly", () => assert.deepEqual(applyFilters(L,{hideFemaleOnly:true}).map(x=>x.id), ["a","c"]));
